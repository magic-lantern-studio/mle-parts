...
#ifndef __MLE_IMAGWMRF_H_
#define __MLE_IMAGWMRF_H_
 ...
 * It is Web-capable.
 */
class MleImageWebMediaRef : public MleImageMediaRef
{
    MLE_MEDIAREF_HEADER(MleImageWebMediaRef);
