 ...
 * @ingroup MleParts
 *
 * This file defines the class for a 3D Geometry Actor.
 *
...
#ifndef __MLE_3DGEOMA_H_
#define __MLE_3DGEOMA_H_
...
#include "mle/3dpickp.h"


class Mle3dGeometryActor : public MleActor
{
    MLE_ACTOR_HEADER(Mle3dGeometryActor);
  ...
  public:
    ...
    Mle3dPickableProperty           pickable;

};


#endif /* __MLE_3DGEOMA_H_ */
