...
#ifndef __MLE_MYPROP3C_H_
#define __MLE_MYPROP3C_H_


#define Property1Type int
#define Property2Type int
#define Property3Type int

class MleRole;

/**
 * @brief Example 3-member property carrier.
 *
 ...
 */
class MyThreePropertyCarrier 
{
public:
    static int set(MleRole* delegate, 
		   Property1Type Property1Name, 
		   Property2Type Property2Name, 
		   Property3Type Property3Name);
    static int get(MleRole* delegate, 
		   Property1Type& Property1Name, 
		   Property2Type& Property2Name, 
		   Property3Type& Property3Name);
};

#endif /* __MLE_MYPROP3C_H_ */
