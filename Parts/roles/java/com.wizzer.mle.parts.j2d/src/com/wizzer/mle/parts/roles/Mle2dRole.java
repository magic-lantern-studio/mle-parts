 ...
 * </p>
 * 
 * @see com.wizzer.mle.parts.j2d.sets.I2dSet
 */
public abstract class Mle2dRole extends MleRole implements I2dRole
{
     ...
     * during the stage phase to draw the Role on the Java2d platform.
     * </p>
     * 
     * @param buffer The buffer to render into.
     */
    public abstract void draw(MleBufferedImage buffer);
