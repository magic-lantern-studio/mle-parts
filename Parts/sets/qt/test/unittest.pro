...
# debug build
unix:!macx: LIBS += \
    -L$$PWD/../build/build-mleqtset-Desktop_Qt_5_12_6_GCC_64bit-Debug/src -lqtset \
...
DEPENDPATH += $$PWD/../build/build-mleqtset-Desktop_Qt_5_12_6_GCC_64bit-Debug/src
} else {
# release build
unix:!macx: LIBS += \
    -L$$PWD/../build/build-mleqtset-Desktop_Qt_5_12_6_GCC_64bit-Release/src -lqtset \
    -L/opt/MagicLantern/lib/mle/runtime -lmlert \
    -L/opt/MagicLantern/lib/mle/qt -lqtstage \
    -L/opt/MagicLantern/lib -lplayprint -lmlutil -lmlmath
